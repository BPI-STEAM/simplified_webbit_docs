...
Web:Bit 编辑器是 Webduino 的学习积木编程软件，它是基于 Webduino Blockly 的操作方式，软件大幅简化了操作的步骤流程，并添加了**虚拟仿真开发板**、**小怪兽互动舞台**、**外接拓展硬件**等许多积木供你玩耍。不论是大朋友小朋友，都可以轻松的入门 Web:Bit 。
...
编辑器分成 **网页版** 和 **安装版**，功能与界面几乎完全相同，可以依据不同的教学场景需求采用不同的版本。
